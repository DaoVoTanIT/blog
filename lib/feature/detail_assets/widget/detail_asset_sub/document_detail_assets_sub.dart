...
class DocumentDetailAssetsSub extends StatefulWidget {
  const DocumentDetailAssetsSub({Key? key, required this.assetsDb})
      : super(key: key);
  final AssetsDb assetsDb;

  @override
  State<DocumentDetailAssetsSub> createState() =>
      _DocumentDetailAssetsSubState();
}

class _DocumentDetailAssetsSubState extends State<DocumentDetailAssetsSub> {
  bool darkMode = false;
            ...
            child: SizedBox(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      assetsDb.db.cmmsAssetDocuments.isEmpty
                          ? Container()
                          : Container(
