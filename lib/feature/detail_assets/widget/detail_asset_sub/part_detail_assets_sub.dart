...
class PartsDetailAssetsSub extends StatefulWidget {
  const PartsDetailAssetsSub({Key? key, required this.assetsDb})
      : super(key: key);
  final AssetsDb assetsDb;

  @override
  State<PartsDetailAssetsSub> createState() => _PartsDetailAssetsSubState();
}

class _PartsDetailAssetsSubState extends State<PartsDetailAssetsSub> {
  bool darkMode = false;
